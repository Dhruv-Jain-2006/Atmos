...
#: All timestamps are timezone-aware. Ingestion spans timezones; naive
#: datetimes here would silently corrupt velocity windows.
...
class TimestampMixin:
    """Row lifecycle timestamps, set by the database."""
